...
with_node \
  ...
  --target "/Volumes/Muhammad Abdullah Baig/Projects/alli/ios/Pods/Target Support Files/Pods-AlliNutritionApp/ExpoModulesProvider.swift" \
  --entitlement "/Volumes/Muhammad Abdullah Baig/Projects/alli/ios/AlliNutritionApp/AlliNutritionApp.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-camera" "expo-clipboard" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-image-picker" "expo-keep-awake" "expo-linear-gradient" "expo-media-library"
